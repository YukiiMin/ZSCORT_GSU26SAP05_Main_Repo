CLASS zcm_scort DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      ...
      BEGIN OF tr_has_inactive_objects,
        msgid TYPE symsgid VALUE 'ZCM_SCORT',
        ...
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      END OF tr_has_inactive_objects,

      BEGIN OF inactive_object_found,
        msgid TYPE symsgid VALUE 'ZCM_SCORT',
        ...
        attr3 TYPE scx_attrname VALUE 'MV_ATTR3',
        attr4 TYPE scx_attrname VALUE '',
      END OF inactive_object_found,

      BEGIN OF release_check_inactive,
        msgid TYPE symsgid VALUE 'ZCM_SCORT',
        ...
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      END OF release_check_inactive,

      BEGIN OF object_check_error_detail,
        msgid TYPE symsgid VALUE 'ZCM_SCORT',
        ...
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      END OF object_check_error_detail,

      BEGIN OF cts_init_failed,
        msgid TYPE symsgid VALUE 'ZCM_SCORT',
